...
public class TA2_Text : MonoBehaviour
{
    ...
    private void Update()
    {
        alice = TriggerScore.A1score;
        daniel = TriggerScore.D1score;
        echo = TriggerScore.E1score;
        yihao = TriggerScore.Y1score;
        me = TriggerScore.M1score;
